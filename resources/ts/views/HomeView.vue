            ...
            >
                ...
                >
                    <div class="flex justify-evenly items-center w-full gap-2">
                        <v-icon name="md-foldercopy" fill="white" scale="3" />
                        <h1 class="text-3xl">Proyectos</h1>
                    </div>
                    <h3>Registros: {{ numberOfProjects }}</h3>
                </div>
                <div
                    class="flex flex-col justify-center items-start w-3/4 h-30 bg-gray-200 rounded-md gap-4 p-4"
                >
                    <div class="flex justify-evenly items-center w-full gap-2">
                        <v-icon name="fa-file-code" fill="white" scale="3" />
                        <h1 class="text-3xl">Tareas</h1>
                    </div>
                    <h3>Registros: {{ numberOfTasks }}</h3>
                </div>
                <div
                    class="flex flex-col justify-center items-start w-3/4 h-30 bg-gray-200 rounded-md gap-4 p-4"
                >
                    <div class="flex justify-evenly items-center w-full gap-2">
                        <v-icon name="io-person" fill="white" scale="3" />
                        <h1 class="text-3xl">Miembros</h1>
                    </div>
                    <h3>Registros: {{ numberOfMembers }}</h3>
                </div>
            </section>
        </template>
    </MainLayout>
